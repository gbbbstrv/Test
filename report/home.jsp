    ...
    <div class="tab-pane  active" id="batch-info">
        <s:form action="addDetail" method="post" namespace="/">
            ...
            <table align="center" cellSpacing="10" style="border-style:dashed;table-layout:fixed;border-width:0px; border-color:#000000;">
                <tbody>
                <tr widht="500">
                    <td width="100" height="25" ><div align="left" style="font-size:20px;">Components：</div></td>
                    <td>
                        <div>
                ...
                <tr height="10"/>
                <tr>
                    <td width="100" height="25" ><div align="left" style="font-size:20px;">Scheduled Start Time:</div></td>
                    <td>
                        <div>
                ...
                <tr>
                    <td width="200" height="25" ><div align="left"  style="font-size:20px;">Scheduled End Time:</div></td>
                    <td>
                ...
                <tr>
                    <td width="100" height="25" ><div align="left" style="font-size:20px;">Description</div></td>
                    <td>
                            <%--<textarea name="cmctext" style="width:200px;height:80px;"></textarea>--%>
...
<div class="container" >
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
        ...
        <tr>
            ...
            <th width="150"><div align="center">Scheduled Start Time</div></th>
            <th width="150"><div align="center">Scheduled End Time</div></th>
            <th ><div align="center">CMC Version</div></th>
        ...
        <s:iterator value="detaillsit" id="u">
            <tr class="siteinfo" siteid="700299022" statcutover="INIT" statrename="INIT">
                ...
                <td width="100"><div align="center"><s:property value="#u.componentName"/></div></td>
                ...
                <td width="200" style="word-break:break-all"><div align="center"><s:property value="#u.cmcVersion"/></div></td>
                <td width="200" style="word-break:break-all"><div align="center"><s:property value="#u.description"/></div></td>
