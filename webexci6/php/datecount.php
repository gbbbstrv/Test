...
$str="select DATE_FORMAT(time,'%Y-%m-%d') as 'date_format',count(*) as 'count'  from commitinfo where project='cctg'  and repository not in('myTest','cctg-sandbox') ";
$str2="select DATE_FORMAT(time,'%Y-%m-%d') as 'date_format',count(*) as 'count'  from commitinfo where project='cctg-fork'  and repository not in('myTest','cctg-sandbox') ";
if($starttime1!=''){
